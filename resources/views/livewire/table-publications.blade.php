<div class="flex flex-col ">
    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            ...
            <div class="flex justify-between sm:ms-6">
                ...
                <div>
                    <a href="{{route('order-publication')}}">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        ...
                        <tr wire:key='{{$publication->id}}'>
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $publication->title }}</h2>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $publication->view_number }}</h2>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $publication->total_views }}</h2>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $publication->click_number }}</h2>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $publication->total_clicks }}</h2>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                            ...
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap text-start">
                                <div>
                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $publication->order }}</h2>
                                </div>
                            </td>
                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                ...
                                <button type="button"
                                            wire:click="setDeletedPublication(@js($publication->id))"
    ...
    {{-- modal --}}
    <x-modal name="confirm-publication-deletion"  focusable>
        
        <form method="post" action="{{$targeted_publication !=null? route('publications.destroy',$targeted_publication->id) :'' }}" class="p-6">
            @csrf
            @method('delete')

            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                {{ __('Etes-vous sûr de vouloir supprimer cet publication ?') }}
            </h2>
